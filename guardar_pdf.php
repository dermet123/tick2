...
$html = '
  <div style="text-align:center; font-size:1px; line-height:1;">
    <h4 style="text-align:center; margin-top:0; margin-bottom:1px; font-size:12px;">xyz</h4>
    <p style="text-align:center; font-size:8px; margin:0;">RUC: 111111111</p>
    <p style="text-align:center; font-size:8px; margin:0;">Ejecrcio Miraflores</p>
  ...
  <p style="margin:0 font-size:3px;"><b>Datos del Remitente:</b> </p>
    <p style="margin:0;"><b>Nombre:</b> ' . htmlspecialchars($user['name']) . '</p>
    <p style="margin:0;"><b>Celular:</b> ' . (isset($user['phone']) ? $user['phone'] : '0000000000') . '</p>
    <p style="margin:0;"><b>Email:</b> ' . (isset($user['email']) ? htmlspecialchars($user['email']) : 'Jr. Los Lirios A-15') . '</p>
  </div>
  <hr style="border-top:1px solid #000; margin:2px 0;">
';
...
$html .= '
  <table cellpadding="1" style="width:100%; font-size:7px; border-collapse:collapse;">
    <tr>
...
$pdf->write2DBarcode($qrContent, 'QRCODE,H', 28, 115, 25, 25);
...
$filename = 'carpeta_pdfs_' . $user['id'] . '_' . $reportNumber . '.pdf';
$fullPath = $folder . $filename;

$pdf->Output($fullPath, 'F'); // Guarda el PDF en el servidor

// Devolver la ruta como respuesta para que el cliente pueda descargarlo si lo desea
